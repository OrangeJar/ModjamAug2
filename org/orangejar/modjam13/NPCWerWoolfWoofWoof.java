...
public class NPCWerWoolfWoofWoof extends EntityMob {
	...
	*/
	...
	public NPCWerWoolfWoofWoof(World par1World) {
		super(par1World);
     ...
     */
    public void setWoolf(boolean par1)
    {
    ...
    public boolean attackEntityFrom(DamageSource par1DamageSource, float par2)
    {
        ...
        else
        {
            ...
            if (entitylivingbase != null && this.worldObj.difficultySetting >= 3 && (double)this.rand.nextFloat() < this.func_110148_a(field_110186_bp).func_111126_e())
            {
                ...
                NPCWerWoolfWoofWoof werwoof = new NPCWerWoolfWoofWoof(this.worldObj);
                ...
                for (int l = 0; l < 50; ++l)
                {
                    ...
                    {
                    	werwoof.setPosition((double)i1, (double)j1, (double)k1);

                        if (this.worldObj.checkNoEntityCollision(werwoof.boundingBox) && this.worldObj.getCollidingBoundingBoxes(werwoof, werwoof.boundingBox).isEmpty() && !this.worldObj.isAnyLiquid(werwoof.boundingBox))
                        {
                            this.worldObj.spawnEntityInWorld(werwoof);
                            werwoof.setAttackTarget(entitylivingbase);
                            werwoof.func_110161_a((EntityLivingData)null);
                            ...
                            werwoof.func_110148_a(field_110186_bp).func_111121_a(new AttributeModifier("Zombie reinforcement callee charge", -0.05000000074505806D, 0));
                            break;
                        }
                    }
                }
    ...
    public void writeEntityToNBT(NBTTagCompound par1NBTTagCompound)
    {
        ...
        if (this.isVillager())
        {
            par1NBTTagCompound.setBoolean("IsWoolf", true);
        }
    ...
    public void readEntityFromNBT(NBTTagCompound par1NBTTagCompound)
    {
        ...
        if (par1NBTTagCompound.getBoolean("IsWoolf"))
        {
            this.setWoolf(true);
        }
    ...
    public void onKillEntity(EntityLivingBase par1EntityLivingBase)
    {
        ...
        if (this.worldObj.difficultySetting >= 2 && par1EntityLivingBase instanceof EntityVillager)
        {
            ...
            NPCWerWoolfWoofWoof werwoof = new NPCWerWoolfWoofWoof(this.worldObj);
            werwoof.copyLocationAndAnglesFrom(par1EntityLivingBase);
            this.worldObj.removeEntity(par1EntityLivingBase);
            werwoof.func_110161_a((EntityLivingData)null);
            werwoof.setWoolf(true);

            if (par1EntityLivingBase.isChild())
            {
            	werwoof.setChild(true);
            }
    ...
    public EntityLivingData func_110161_a(EntityLivingData par1EntityLivingData)
    {
        ...
        {
            par1EntityLivingData1 = new NPCWerWoolfGroupData(this, this.worldObj.rand.nextFloat() < 0.05F, this.worldObj.rand.nextFloat() < 0.05F, (NPCWerWoolfINNER1)null);
        }

        if (par1EntityLivingData1 instanceof NPCWerWoolfGroupData)
        {
        	NPCWerWoolfGroupData npcwerwoofgroupdata = (NPCWerWoolfGroupData)par1EntityLivingData1;

            if (npcwerwoofgroupdata.field_142046_b)
            {
                this.setWoolf(true);
            }

            if (npcwerwoofgroupdata.field_142048_a)
            {
                this.setChild(true);
            }
        }
