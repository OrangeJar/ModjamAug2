...
public class RenderPotionmk3 implements IItemRenderer {

    ModelCubeWorld model;

    public RenderPotionmk3() {
        model = new ModelCubeWorld(ModJam13.class.getResourceAsStream("/assets/modjam13/models/cactus-potion.cub"));
    }
